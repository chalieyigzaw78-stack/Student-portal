...
Grade is calculated but must be confirmed/overridden by staff before saving.
"""
...
def grade_to_point(grade):
    mapping = {"A": 4.0, "B+": 3.5, "B": 3.0, "C+": 2.5, "C": 2.0, "D": 1.0, "F": 0.0}
...
def calc_gpa(results):
    ...
    total_credits = 0
    for r in results:
        point = grade_to_point(r["confirmed_grade"])
        total_points  += point * r["credit_hours"]
